<%@ Page Title="" Language="VB" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage(of CuriousB.InitialClusteringModel)" %>
...
<asp:Content ID="ClusteringContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
		<div class="col-lg-12">
			<h3 class="page-header">Initial Clustering Report</h3>
                    ...
                    <div class="engagement-chart">
					    ...
					    <table data-toggle="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><%=CuriousB.cbHelpers.ClusterName(rowList("Name"))%></td>
                                    ...
                                    <td><%=rowList("Cluster_7")%></td>
                                    <td><%=rowList("Cluster_8")%></td>
                                    <td><%=rowList("Cluster_9")%></td>
                                </tr>
                                <%Next%>
                            </tbody>
                        </table>
