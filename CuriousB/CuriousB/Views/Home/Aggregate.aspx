<%@ Page Title="" Language="VB" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage(of CuriousB.AggregateModel)" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="ScriptsSection" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(window).on('resize', function () {
            ...
            plotPieChart('pieTopEmailClients', pieTopEmailClientsData, 'Top Email Clients');
            plotPieChart('pieTopDevices', pieTopDevicesData, 'Top Email Clients');
            plotPieChart('pieTopWebmails', pieTopWebmailsData, 'Top Email Clients');
            plotPieChart('pieTopPhones', pieTopPhonesData, 'Top Email Clients');
            plotPieChart('pieTopTablets', pieTopTabletsData, 'Top Email Clients');
