<%@ Page Title="" Language="VB" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage(of CuriousB.EmailEngagementModel)" %>
					    ...
					    <table data-toggle="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><%=rowList.Name%></td>
                                    <td><%=rowList.NumDeployed.ToString("#,###.##", Model.CurrentNumberFormat)%></td>
                                    <td><%=rowList.NumReceived.ToString("#,###.##", Model.CurrentNumberFormat)%></td>
